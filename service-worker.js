                ...
                event.waitUntil(
                    caches.open('cache').then(function (cache) {
                        ...
                        ([
                            ...
                            '/images/assets/team/_isdejavu.jpg',
                            '/images/assets/team/davidteejayc.jpg',
                            '/images/assets/team/harjacober2.jpg',
                            '/images/assets/team/itsmanuellee.jpg',
                            '/images/assets/team/notOnTwitterShit.jpg',
                            '/images/assets/team/osivwiokiti.jpg',
                            '/images/assets/team/roscoefab.jpg',
                            '/images/assets/team/wrecodde.jpg',
                            '/js/custom.js',
                            '/js/data.js',
